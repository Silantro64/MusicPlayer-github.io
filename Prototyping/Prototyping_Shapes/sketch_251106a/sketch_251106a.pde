...
float stopX = image2X + imageWidth  * 1/4 ;
float stopY = imageY + imageHeight * 1/4 ;
float stopDimension = imageY * 1/16 ;
float fastX1 = image3X + imageWidth * 1/4 ;
float fastY1 = imageY + imageHeight * 1/4 ;
float fastX2 = image3X + imageWidth * 2/4 ;
float fastY2 = imageY + imageHeight * 1/2 ;
float fastX3 = image3X + imageWidth * 1/4 ;
float fastY3 = imageY + imageHeight * 3/4 ;
float fasterX1 = image3X + imageWidth * 1/2 ;
float fasterX2 = image3X + imageWidth * 3/4 ;
float fasterX3 = image3X + imageWidth * 1/2 ;
...
float skipX1 = image5X + imageWidth * 1/4 ;
float skipY1 = imageY + imageHeight * 1/4 ;
float skipX2 = image5X + imageWidth * 2/4 ;
float skipY2 = imageY + imageHeight * 1/2 ;
float skipX3 = image5X + imageWidth * 1/4 ;
float skipY3 = imageY + imageHeight * 3/4 ;
float skipY = imageY + imageHeight * 1/4 ;
float skipWidth = image5X * 0.2/16 ;
float skipHeight = imageY * 1/16 ;
float skipX = image5X + imageWidth * 1/2; 
float muteX = image6X + imageWidth  * 1/4 ;
float muteY = imageY + imageHeight * 1/4 ;
float muteDimension = imageY * 1/16 ;
float muteX1 = image6X + imageWidth * 1/4 ;
float muteY1 = imageY + imageHeight * 1/4 ;
float muteX2 = image6X + imageWidth * 2.7/4 ;

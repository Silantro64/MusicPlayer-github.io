...
float muteX = button2X + buttonWidth  * 1/4 ;
float muteY = buttonY + buttonHeight * 1/4 ;
float muteDimension = buttonY * 1/16 ;
float muteX1 = button2X + buttonWidth * 1/4 ;
float muteY1 = buttonY + buttonHeight * 1/4 ;
float muteX2 = button2X + buttonWidth * 2.7/4 ;
float muteY2 = buttonY + buttonHeight * 1/4 ;
float muteX3 = button2X + buttonWidth * 1/4 ;
float muteY3 = buttonY + buttonHeight * 3/4 ;
float backX1 = button3X + buttonWidth * 1.8/4 ;
float backY1 = buttonY + buttonHeight * 1/4 ;
float backX2 = button3X + buttonWidth * 0.8/4 ;
float backY2 = buttonY + buttonHeight * 1/2 ;
float backX3 = button3X + buttonWidth * 1.8/4 ;
float backY3 = buttonY + buttonHeight * 3/4 ;
float backedX1 = button3X + buttonWidth * 2.8/4 ;
float backedX2 = button3X + buttonWidth * 1.8/4 ;
float backedX3 = button3X + buttonWidth * 2.8/4 ;
//
